...
class HWD(nn.Module):
    ...
    def set_input_to_diffmodel(self, noisy_data, observed_data, cond_mask):
        if getattr(self.configs, 'arch_v2', False):
            # ARCH V2: jalur langsung cond_obs DIHAPUS.
            # Model hanya menerima target berderau; informasi nilai teramati
            # sepenuhnya disalurkan lewat wavelet conditioning.
